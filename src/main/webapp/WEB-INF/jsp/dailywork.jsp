      ...
      <section class="container-fluid">
        <div>
          ...
          <div class="columnas">
            ...
            <div class="width70"> 
              <div class="columnas-izquierda">
                ...
                <div class="card shadow m-column m-right">
                  ...
                  <!-- Card Body -->
                  <div class="card-body p-0" id="cardBodyTckBlocked">
                    <div class="chart-area">
                      <table>
                        <thead>
                          <tr>
            ...
            <div class="width30"> 
              <div class="columnas-derecha align_columns columna-derecha-dailywork">

                <div class="card shadow m-column m-left width100 fit-content ">
                  ...
                  <div class="card-body p-0 carga-style" id="cardBodyCarga" >
                    ...
                    <div class="chart-area width50">
                      <c:forEach items="${workLoad.listWorkPerEmployee}" var="workPerEmployee">
                          <div class="carga">
                              <!-- Enlace para alternar el colapso -->
                              <a class="nav-link carga dropdown-toggle collapsed" href="#" 
                                data-bs-toggle="collapse" 
                                data-bs-target="#collapseCargaTrabajo${workPerEmployee.userEmployee}">
                                  <span class="carga-tittle">
                                      ${workPerEmployee.userEmployee}
                                  </span>
                              </a>
                              <!-- Contenedor del colapso -->
                              <div id="collapseCargaTrabajo${workPerEmployee.userEmployee}" class="collapse">
                                  <ul class="list-group">
                ...
                <div class="card shadow m-column m-left width100">
                  ...
                  <div class="d-flex flex-column align-items-center" id="cardBodyBar">

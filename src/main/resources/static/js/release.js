...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var requirementsDateHidden = document.getElementById('requirementsDateHidden').value;
    var prjAssignmentDateHidden = document.getElementById('prjAssignmentDateHidden').value;
    var developDateHidden = document.getElementById('developDateHidden').value;
    var tstDateHidden = document.getElementById('tstDateHidden').value;
    var uatDateHidden = document.getElementById('uatDateHidden').value;
    var proDateHidden = document.getElementById('proDateHidden').value;
    ...
    const renderCalendar = () => {
        ...
        for (let i = 1; i <= lastDateofMonth; i++) {
            ...
            let isRequirementsDate = isSameDay(new Date(currYear, currMonth, i), new Date(requirementsDateHidden));
            let isPrjAssignmentDate = isSameDay(new Date(currYear, currMonth, i), new Date(prjAssignmentDateHidden));
            let isDevelopDate = isSameDay(new Date(currYear, currMonth, i), new Date(developDateHidden));
            let isTstDate = isSameDay(new Date(currYear, currMonth, i), new Date(tstDateHidden));
            let isUatDate = isSameDay(new Date(currYear, currMonth, i), new Date(uatDateHidden));
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var formattedrequirementsDate = formatDateTime(requirementsDateHidden);
    var formattedprjAssignmentDate = formatDateTime(prjAssignmentDateHidden);
    var formatteddevelopDate = formatDateTime(developDateHidden);
    var formattedtstDate = formatDateTime(tstDateHidden);
    var formatteduatDate = formatDateTime(uatDateHidden);
    var formattedproDate = formatDateTime(proDateHidden);
...
document.addEventListener('DOMContentLoaded', (event) => {
    document.getElementById('saveProjectButton').addEventListener('click', function() {
        ...
        var nameRelease = document.getElementById('nameReleaseHidden').value;
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('deleteTicketButtonRelease').addEventListener('click', function() {
        ...
        var url = `/releases/`+releaseId+`/delete`;
...
document.addEventListener('DOMContentLoaded', (event) => {
    document.getElementById('updateReleaseButton').addEventListener('click', function() {
        ...
        var releaseId = document.getElementById('releaseId').value;
        var url = `/releases/`+releaseId+`/edit`;
